import { a as $Typed, $ as $TypedObject } from './util-B5oZwPdx.cjs';
import { ValidationResult } from '@atproto/lexicon';
import { U as Uri, S as SmallBlob } from './claim-ZxCHJfe5.cjs';
import { S as SmallImage, U as Uri$1, a as SmallBlob$1 } from './defs-MUlUt4qq.cjs';
...
declare function isMain$1<V>(v: V): v is $TypedObject<V, "app.gainforest.organization.info", "main">;
...
declare function isMain<V>(v: V): v is $TypedObject<V, "app.gainforest.organization.site", "main">;
declare function validateMain<V>(v: V): ValidationResult<Main & V>;

type AppGainforestOrganizationSite_Main = Main;
declare const AppGainforestOrganizationSite_isMain: typeof isMain;
declare const AppGainforestOrganizationSite_validateMain: typeof validateMain;
declare namespace AppGainforestOrganizationSite {
  export { type AppGainforestOrganizationSite_Main as Main, type Main as Record, AppGainforestOrganizationSite_isMain as isMain, isMain as isRecord, AppGainforestOrganizationSite_validateMain as validateMain, validateMain as validateRecord };
}

export { AppCertifiedLocation as A, type Main$3 as M, type Main$2 as a, type Main$1 as b, type Main as c, AppGainforestOrganizationDefaultSite as d, AppGainforestOrganizationInfo as e, AppGainforestOrganizationSite as f };
