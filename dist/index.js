...
var ContributorInputSchema = z8.object({
  identity: z8.string().min(1, "Contributor identity is required"),
...
var ClaimActivityInputSchema = z8.object({
  ...
  workScope: z8.string().optional(),
  startDate: z8.string().optional(),
  endDate: z8.string().optional(),
  contributors: z8.array(ContributorInputSchema).optional(),
...
var VisibilitySchema = z8.enum(["Public", "Unlisted"]);
...
var LocationUpdateInputSchema = z8.object({
  ...
  description: z8.string().optional(),
  shapefile: z8.object({
    $type: z8.literal("org.hypercerts.defs#smallBlob"),
