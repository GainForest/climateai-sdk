...
var BlobRefGeneratorSchema = z5.object({
  $type: z5.literal("blob-ref-generator"),
  ref: z5.object({
    $link: z5.string()
  }),
  mimeType: z5.string(),
...
var FileGeneratorSchema = z5.object({
  name: z5.string(),
  type: z5.string(),
...
var StrongRefSchema = z5.object({
  $type: z5.literal("com.atproto.repo.strongRef").optional(),
  uri: z5.string().regex(/^at:\/\//),
  cid: z5.string()
});
...
var ContributorInputSchema = z5.object({
  identity: z5.string().min(1, "Contributor identity is required"),
  weight: z5.string().optional(),
  role: z5.string().optional()
});
var ClaimActivityInputSchema = z5.object({
  title: z5.string().min(1, "Title is required"),
  shortDescription: z5.string().min(1, "Short description is required"),
  description: z5.string().optional(),
  locations: StrongRefSchema.array().optional(),
  workScope: z5.string().optional(),
  startDate: z5.string().optional(),
  endDate: z5.string().optional(),
  contributors: z5.array(ContributorInputSchema).optional(),
  createdAt: z5.string().optional()
});
var ClaimActivityUploadsSchema = z5.object({
...
var VisibilitySchema = z5.enum(["Public", "Unlisted"]);
var OrganizationInfoInputSchema = z5.object({
  displayName: z5.string().min(1, "Display name is required"),
  shortDescription: z5.string().min(1, "Short description is required"),
  longDescription: z5.string().min(1, "Long description is required"),
  website: z5.string().url("Website must be a valid URL").optional(),
  logo: BlobRefGeneratorSchema.optional(),
  coverImage: BlobRefGeneratorSchema.optional(),
  objectives: z5.array(ObjectivesSchema).min(1, "At least one objective is required"),
...
var OrganizationInfoUploadsSchema = z5.object({
...
var LayerInputSchema = z5.object({
  name: z5.string().min(1, "Layer name is required"),
  type: LayerTypeSchema,
  uri: z5.string().url("Layer URI must be a valid URL"),
  description: z5.string().optional(),
  createdAt: z5.string().datetime().optional()
});
...
var LocationInputSchema = z5.object({
  name: z5.string().optional(),
  description: z5.string().optional()
});
var LocationUploadsSchema = z5.object({
  shapefile: z5.union([z5.string().url(), FileGeneratorSchema])
});
...
var LocationUpdateInputSchema = z5.object({
  name: z5.string().optional(),
  description: z5.string().optional(),
  shapefile: z5.object({
    $type: z5.literal("org.hypercerts.defs#smallBlob"),
    blob: BlobRefGeneratorSchema
  }).optional()
});
var LocationUpdateUploadsSchema = z5.object({
...
var AppRouterFactory = class {
  constructor(_allowedPDSDomains) {
    ...
    this.allowedPDSDomainSchema = z5.enum(this.allowedPDSDomains);
