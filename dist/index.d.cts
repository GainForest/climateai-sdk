...
import { M as Main, a as Main$1, b as Main$2, c as Main$3, d as Main$4, e as Main$5, U as Uri, S as SmallImage, L as LargeImage, f as SmallBlob, g as LargeBlob } from './info-xhW3nV2i.cjs';
...
import { StoredSession } from './server/session.cjs';
import z, { z as z$1 } from 'zod';
import { SupportedPDSDomain as SupportedPDSDomain$1 } from '@/index';
...
declare class AppRouterFactory<T extends SupportedPDSDomain$1> {
    allowedPDSDomains: T[];
...
type AppRouter<T extends SupportedPDSDomain$1> = AppRouterFactory<T>["appRouter"];

declare function createContext<T extends SupportedPDSDomain$1>(opts?: {
    req?: Request;
    allowedPDSDomains: T[];
}): Promise<{
    session: StoredSession | null;
...
export { type AppRouter, ClimateAiSDK, type SupportedPDSDomain, createContext, supportedPDSDomainSchema };
